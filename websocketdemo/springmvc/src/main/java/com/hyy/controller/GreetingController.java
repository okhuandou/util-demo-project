...
public class GreetingController {
    ...
    public Greeting greeting(@Header("atytopic") String topic, @Headers Map<String, Object> headers,@RequestBody  String body) {
    ...
    public Greeting send() {
    	simpMessageSendingOperations.convertAndSend("/message", new Greeting("I am a msg from SubscribeMapping('/macro')."));
